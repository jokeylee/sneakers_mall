<?php 
    ...
    $result=mysqli_query($conn,"select * from class_list weight where id='".$id."'");
...
<div class="form-add">
<form action="handle_editClass.php?id=<?=$id?>" method="post">
<table class="table  table-bordered table-hover">
	<tr>
		<td align="right"><span class="td-txt">类目名称</span></td>
		<td><input type="text" name="name" value="<?php echo $row['class_name'];?>"/></td>
	</tr>
    <tr>
        <td align="right"><span class="td-txt">类目权重</span></td>
        <td><input type="text" name="weight" maxlength="4" value="<?php echo $row['class_weight'];?>"/></td>
    </tr> 
</table>
